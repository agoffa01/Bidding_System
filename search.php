...
<head>
    ...
    <title>NYUBids - Buyer - Books</title>
    <!-- Bootstrap -->  
...
<div class="custom-list">
    ...
    <?php
        if(isset($_GET["submit"])){
            $tosearch = "%".strtolower($_GET["tosearch"]). "%";
            //echo $tosearch;
            $info = preparedStatement($con, "search_query", $tosearch, "select item_name, item_id, category, current_bid_price, condition, description, image1 from item where category like $1 or item_name like $1");
            ...
            while($iter = pg_fetch_array($info)){
                ...
                if(strlen($iter['image1']) == 0){
                    Print "      <img src='images/noImage.jpg alt='noImage'>"; 
                } 
                else{
