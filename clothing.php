...
<head>
    ...
    <title>NYUBids - Buyer - Clothing & Shoes </title>
    <!-- Bootstrap -->  
...
<div class="custom-list">
    ...
    <?php
        $info = preparedStatement($con, "category_query", "clothing and shoes", "select item_name, item_id, category, current_bid_price, condition, description, image1 from item where category = $1");
