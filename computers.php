...
<head>
    ...
    <title>NYUBids - Buyer - Computers</title>
    <!-- Bootstrap -->  
...
<div class="custom-list">
    ...
    <?php
        $info = preparedStatement($con, "category_query", "computers", "select item_name, item_id, category, current_bid_price, condition, description, image1 from item where category = $1");
