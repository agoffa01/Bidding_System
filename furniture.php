...
<head>
    ...
    <title>NYUBids - Buyer - Furniture</title>
    <!-- Bootstrap -->  
...
<div class="custom-list">
    ...
    <?php
        $info = preparedStatement($con, "category_query", "furniture", "select item_name, item_id, category, current_bid_price, condition, description, image1 from item where category = $1");
